...
-- (1) Retrieve the list of students and their enrolled courses.
...
-- (2) List all students and their enrolled courses, including those who haven't enrolled in any course.
...
-- (3) Display all courses and the students enrolled in each course, including courses with no enrolled students.
...
-- (4) Find pairs of students who are enrolled in at least one common course.
...
-- (5) Retrieve students who are enrolled in 'Introduction to CS' but not in 'Data Structures'.
...
-- (6) List all students along with a row number based on their enrollment date in ascending order.
...
-- (7) Rank students based on the number of courses they are enrolled in, handling ties by assigning the same rank.
...
-- (8) Determine the dense rank of courses based on their enrollment count across all students

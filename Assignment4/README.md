...
![loog](./images/day4q2.png)


```sh

-- (3) Create a view to show the details of all Senior Analysts.
...
![loog](./images/day4q3.png)


```sh

-- (4) Create a materialized view to store the count of employees by department.
...
![loog](./images/day4q4.png)


```sh

-- (5) Create a procedure to update an employee's salary by their first name and last name.
...
-- (6) Create a procedure to calculate the total number of leaves used across all departments.
...
![loog](./images/day4q6.png)

```sh


-- (7) Create a procedure to calculate the total number of leaves used departments wise.
